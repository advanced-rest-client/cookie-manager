...
declare namespace UiElements {
   ...
   * `--context-menu-color` | Context menu color | `--context-menu-color` or `rgba(0, 0, 0, 0.87)`
   * `--context-menu-color-hover` | Context menu color when hovered | `currentcolor`
   * `--context-menu-background-color-hover` | Menu bg color when hovered | `rgba(0, 0, 0, 0.12)`
   */
